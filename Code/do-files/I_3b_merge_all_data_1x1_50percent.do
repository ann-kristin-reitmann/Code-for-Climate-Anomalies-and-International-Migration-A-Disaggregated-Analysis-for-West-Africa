...
*-------------------------------------------------------------------------------------------
* 3b. Data prep do-file: match FMS data to raster data (robustness 50%)
*-------------------------------------------------------------------------------------------
...
*This do-file merges all data at the 1x1 degrees cell size (robustness 50%)
...
use "data\FMS_2018_2019_urban_50percent.dta", clear
	sort cellid myear 
	keep cellid 
	duplicates drop 
	gen urban=1
...
save "data\urban_cell_50percent.dta", replace

use "data\FMS_2018_2019_cells_50percent.dta", clear
...
merge m:1 _ID using "data\urban_cell_50percent.dta"
...
save "data\cells_1by1_all_50percent.dta", replace
...
use "data\cells_1by1_all_50percent.dta", clear
