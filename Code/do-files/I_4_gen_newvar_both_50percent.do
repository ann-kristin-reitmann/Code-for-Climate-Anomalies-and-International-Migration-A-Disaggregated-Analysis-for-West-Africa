...
*-------------------------------------------------------------------------------------------
* 4. Data prep do-file: new variables (robustness 50%)
*-------------------------------------------------------------------------------------------
...
*This do-file creates new variables for both grid sizes (robustness 50%)
...
use "data\cells_`data'_all_50percent.dta", clear 
...
save "data/final_cell_`data'_month_50percent.dta", replace
...
save "data/final_cell_`data'_50percent.dta", replace 
