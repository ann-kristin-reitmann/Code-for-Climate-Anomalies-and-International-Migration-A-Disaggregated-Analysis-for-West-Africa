...
*This do-file creates Figure A9
...
foreach var in cinter {
	...
	ppmlhdfe `var'  b2.`sma'  $control $fe if ///
...
local resultsgs 	ppml_cinter_clrsmal1gs ppml_cinter_clrsma2gs ppml_cinter_clrsma3gs ///
					ppml_cinter_clrsma4gs ppml_cinter_clrsma5gs ppml_cinter_clrsma6gs ///
					ppml_cinter_clrsma7gs ppml_cinter_clrsma8gs ppml_cinter_clrsma9gs ///
					ppml_cinter_clrsma10gs ppml_cinter_clrsma11gs ppml_cinter_clrsma12gs				
...
graph export "output/figures/figure_A9.pdf", replace 
