...
*-------------------------------------------------------------------------------------------
* 5a. Data prep do-file: restricted sample (robustness 50%)
*-------------------------------------------------------------------------------------------
...
*This do-file generates the restricted sample, which we will use for the rest of the analysis (robustness 50%)
*Note: This data is for running the robustness check "FMPs with best coverage of departure location information" 

use "data/final_cell_5by5_month_50percent.dta", clear
...
save "data/final_cell_5by5_month_sample_50percent.dta", replace
