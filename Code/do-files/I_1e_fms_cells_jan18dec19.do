...
*-------------------------------------------------------------------------------------------
* 1e. Data prep do-file: match FMS data to raster data (robustness Jan 18 - Dec 19)
*-------------------------------------------------------------------------------------------
...
*This do-file joins FMS data with the cell id (robustness Jan 18 - Dec 19)
...
use "data\FMS_2018_2019_clean_jan18dec19.dta", clear
...
local path `data' 
	...
	save "data\FMS_2018_2019_cells_jan18dec19.dta", replace

	preserve 
	keep if largecity==1 // keep urban migration 
	save "data\FMS_2018_2019_urban_jan18dec19.dta", replace
	restore 

	preserve
	keep if largecity==0 // keep rural migration 
	save "data\FMS_2018_2019_rural_jan18dec19.dta", replace
	restore 
	}
	
	if  "`path'" == "matched_5x5" {

	save "data\FMS_2018_2019_cells_5x5_jan18dec19.dta", replace

	preserve 
	keep if largecity==1 // keep urban migration 
	save "data\FMS_2018_2019_urban_5x5_jan18dec19.dta", replace
	restore 

	preserve
	keep if largecity==0 // keep rural migration 
	save "data\FMS_2018_2019_rural_5x5_jan18dec19.dta", replace
	restore 
	}
