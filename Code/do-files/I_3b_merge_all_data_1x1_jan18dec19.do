...
*-------------------------------------------------------------------------------------------
* 3b. Data prep do-file: match FMS data to raster data (robustness Jan 18 - Dec 19)
*-------------------------------------------------------------------------------------------
...
*This do-file merges all data at the 1x1 degrees cell size (robustness Jan 18 - Dec 19)
...
use "data\FMS_2018_2019_urban_jan18dec19.dta", clear
	sort cellid myear 
	keep cellid 
	duplicates drop 
	gen urban=1
	rename cellid _ID 
save "data\urban_cell_jan18dec19.dta", replace

use "data\FMS_2018_2019_cells_jan18dec19.dta", clear
...
append using "data\temp.dta" // sppend dates for 2017 
...
merge m:1 _ID using "data\urban_cell_jan18dec19.dta"
...
save "data\cells_1by1_all_jan18dec19.dta", replace
...
use "data\cells_1by1_all_jan18dec19.dta", clear
