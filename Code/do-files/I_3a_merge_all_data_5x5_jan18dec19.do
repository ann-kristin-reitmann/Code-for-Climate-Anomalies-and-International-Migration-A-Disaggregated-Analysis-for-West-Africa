...
*-------------------------------------------------------------------------------------------
* 3a. Data prep do-file: match FMS data to raster data (robustness Jan 18 - Dec 19)
*-------------------------------------------------------------------------------------------
...
*This do-file merges all data at the .5x.5 degrees cell size (robustness Jan 18 - Dec 19)
...
use "data\FMS_2018_2019_urban_5x5_jan18dec19.dta", clear
	sort cellid myear 
	keep cellid 
	duplicates drop 
	gen urban=1
	rename cellid _ID 
save "data\urban_cell_5x5_jan18dec19.dta", replace

use "data\FMS_2018_2019_cells_5x5_jan18dec19.dta", clear
...
merge m:1 _ID using "data\urban_cell_5x5_jan18dec19.dta"
...
save "data\cells_5by5_all_jan18dec19.dta", replace
...
use "data\cells_5by5_all_jan18dec19.dta", clear
