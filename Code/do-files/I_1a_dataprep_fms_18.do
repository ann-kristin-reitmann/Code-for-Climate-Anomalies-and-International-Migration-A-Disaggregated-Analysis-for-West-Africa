...
import excel using "data\_orig\WCA_FMS_DATA_2018.xlsx", clear sheet(FMS_WCA) firstrow
save "data\FMS_WCA_DATA_2018.dta", replace 
...
use "data\FMS_WCA_DATA_2018.dta", clear

rename *, lower

local variables q1_0_survey_country q1_1_survey_date q1_2_fmp_point q2_1_nationality ///
q2_3_sexe q2_4_age q2_5_marital_status q2_6_education /// 
q2_7_employment_status q2_8_main_occupation q2_9_description_occupation ///
q3_2_leave_when q3_3_forcibly_displaced q3_4_attempt_migrate q3_5_journey_reason ///
q3_6_economic_reason q3_7_access_services_list q3_9_last_transit_main_transport /// 
q4_1_final_destination q4_1_next_destination q4_3_destination_why q4_4_how_long q4_5_want_return ///
q4_6_return_when q5_referral_mechanism_y_n q5_1_difficulties_journey_y_n ///
q5_2_three_difficulties q5_3_need_info_y_n q5_4_need_info_type
...
local variables q2_2_1_origin_birth_country q2_2_2_origin_birth_admin1 ///
/*q2_2_3_origin_birth_admin2*/ q2_2_4_langue_ethny q3_0_1_departure_country ///
q3_0_2_departure_admin1 q3_0_3_departure_location q3_8_2_transit_country ///
q3_8_3_last_transit_admin1 /*q3_8_4_last_transit_admin2*/ ///
q3_8_5_last_transit_location q3_8_1_last_transit_y_n ///
...
local variables q3_10_travel_with q3_11_group_family q3_12_number_indiv_group ///
q3_13_pay_travel 
...
rename last_transit_y_n last_transit
rename ferral_mechanism_y_n referral_mechanism 
rename difficulties_journey_y_n difficulties_journey 
rename need_info_y_n need_info
rename sexe sex
...
local variables survey_country nationality origin_birth_country departure_country ///
...
replace journey_reason="Attend family event" 		if journey_reason=="Attend family event (wedding, funeral, etc.)"
replace journey_reason="Economic reasons" 			if journey_reason=="Economic reasons"
replace journey_reason="Natural disasters" 			if journey_reason=="Natural disasters (floods, drought, earthquake, etc.)"
...
replace journey_reason="Violence or persecution"	if journey_reason=="Targeted violence or persecution"
replace journey_reason="War or conflict" 			if journey_reason=="War/conflict"
replace journey_reason="Religious event" 			if journey_reason=="religious_event"
...
replace educationnew=3 if education=="Lower Secondary"
replace educationnew=4 if education=="Upper Secondary"
...
replace educationnew=8 if education=="koranic_islamic_schl"
...
gen leave_whennew=. 
replace leave_whennew=1 if leave_when=="Today or less than 2 weeks ago"
...
difficulties_journey need_info {
...
gen return_whennew=. 
	replace return_whennew=1 if return_when=="within_this_week"
	replace return_whennew=2 if return_when=="between_one_week_and_3_months"
	replace return_whennew=3 if return_when=="between_3_and_12_months"
	replace return_whennew=4 if return_when=="in_one_year_or_later"
	replace return_whennew=5 if return_when=="connot_go_back"
	replace return_whennew=6 if return_when=="unknown"
...
save "data\FMS_WCA_2018_clean.dta",  replace
