...
*-------------------------------------------------------------------------------------------
* 1c. Data prep do-file: join FMS 2018 and 2019 (robustness 50%)
*-------------------------------------------------------------------------------------------
...
*This do-file joins FMS data for 2018 and 2019 (robustness 50%)
...
*-------------------------------------------------------------------------------------------
* IV. Drop migrants coming from FMPs with more than 50% departure location missing
*------------------------------------------------------------------------------------------- 

*only keep migrants from FMPs that recorded less than 50% of departure locations as missing

drop if fmp_point=="Benena"
drop if fmp_point=="Kano"
drop if fmp_point=="Menaka"
drop if fmp_point=="Place Kidal"
drop if fmp_point=="Sokoto"
drop if fmp_point=="Wabaria"
                                                           
*-------------------------------------------------------------------------------------------
* V. Save data
*-------------------------------------------------------------------------------------------
															   
save "data\FMS_2018_2019_clean_50percent.dta", replace
