...
*-------------------------------------------------------------------------------------------
* 3a. Data prep do-file: match FMS data to raster data (robustness 50%)
*-------------------------------------------------------------------------------------------
...
*This do-file merges all data at the .5x.5 degrees cell size (robustness 50%)
...
use "data\FMS_2018_2019_urban_5x5_50percent.dta", clear
	sort cellid myear 
	keep cellid 
	duplicates drop 
	gen urban=1
	rename cellid _ID 
save "data\urban_cell_5x5_50percent.dta", replace

use "data\FMS_2018_2019_cells_5x5_50percent.dta", clear
...
merge m:1 _ID using "data\urban_cell_5x5_50percent.dta"
...
save "data\cells_5by5_all_50percent.dta", replace
...
use "data\cells_5by5_all_50percent.dta", clear
