...
foreach var in cinter {
	...
	xtnbreg `var' c.`sma'  $control $fe if ///
...
local resultsgs 	res_cinter_lrsmal1gs res_cinter_lrsma2gs res_cinter_lrsma3gs ///
					res_cinter_lrsma4gs res_cinter_lrsma5gs res_cinter_lrsma6gs ///
					res_cinter_lrsma7gs res_cinter_lrsma8gs res_cinter_lrsma9gs ///
					res_cinter_lrsma10gs res_cinter_lrsma11gs res_cinter_lrsma12gs
...
graph export "output/figures/figure_05.pdf", replace 	
