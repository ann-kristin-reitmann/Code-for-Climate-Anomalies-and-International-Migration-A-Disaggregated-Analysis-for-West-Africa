...
*-------------------------------------------------------------------------------------------
* 5a. Data prep do-file: restricted sample (robustness SMA 20 years)
*-------------------------------------------------------------------------------------------
...
*This do-file generates the restricted sample, which we will use for the rest of the analysis (robustness SMA 20 years)
*Note: This data is for running the robustness check "SMA based on past 20 years"
...
gen smal1=l1.sma if  _ID==_ID[_n-1]	

gen smal1gs=l1.sma if  growcrop[_n-1]==1 & _ID==_ID[_n-1]	
...
smal1 sma2 sma3 sma4 sma5 sma6 ///
sma7 sma8 sma9 sma10 sma11 sma12 ///
smal1gs sma2gs sma3gs sma4gs sma5gs sma6gs ///
sma7gs sma8gs sma9gs sma10gs sma11gs sma12gs  {
...
foreach var in dinter cinter {
  ...
  foreach sma in smal1 sma2 sma3 sma4 sma5 sma6 ///
					sma7 sma8 sma9 sma10 sma11 sma12 {
...
save "data/final_cell_5by5_month_sample_20ySMA.dta", replace
