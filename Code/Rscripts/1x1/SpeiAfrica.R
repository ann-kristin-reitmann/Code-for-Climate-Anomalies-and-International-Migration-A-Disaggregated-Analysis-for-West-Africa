...
#You an change spei03 for spe101 and spei06 as well 
...
spei.brick <- brick('./_orig/SPEIbase-2.5.1/outputNcdf/spei03.nc')
...
spei.df = as.data.frame(spei.mask[[1381:1416]], xy=TRUE)  #Specify the columns to extract from database
...
write.csv(shp.df, file = "./Rdata/spei03_cells.csv")
...
T1 <- tm_shape(shp) + 
  tm_polygons(c("Jan2017", "Feb2017", "Mar2017", "Apr2017"), style = "cont", title = c("SPEI 01-17", "SPEI 02-17", "SPEI 03-17", "SPEI 04-17"),  palette="RdYlBu") +
  tm_layout(legend.position = c("left", "bottom"))
tmap_save(T1, "./SPEI03_T1_2017.pdf")

T2 <- tm_shape(shp) + 
  tm_polygons(c("May2017", "Jun2017", "Jul2017", "Aug2017"), style = "cont", title = c("SPEI 05-17", "SPEI 06-17", "SPEI 07-17", "SPEI 08-17"),  palette="RdYlBu") +
  tm_layout(legend.position = c("left", "bottom"))
tmap_save(T2, "./SPEI03_T2_2017.pdf")

T3 <- tm_shape(shp) + 
  tm_polygons(c("Sep2017", "Oct2017", "Nov2017", "Dec2017"), style = "cont", title = c("SPEI 09-17", "SPEI 10-17", "SPEI 11-17", "SPEI 12-17"),  palette="RdYlBu") +
  tm_layout(legend.position = c("left", "bottom"))
